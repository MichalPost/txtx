    ...
    >
      {xpath ? (
        <>
          ...
          <button
            className="flex shrink-0 items-center gap-1.5 rounded-lg border px-2.5 py-1 text-xs font-medium transition-all hover:opacity-80"
            style={{
          ...
          {onXPathSelect && (
            <div className="relative shrink-0">
              <button
                className="flex items-center gap-1.5 rounded-lg border px-2.5 py-1 text-xs font-medium transition-all hover:opacity-80"
                style={{
              ...
              {showFieldPicker && (
                <div
                  className="absolute right-0 bottom-full mb-1.5 overflow-hidden rounded-xl border"
                  style={{
                    background: "var(--color-surface)",
                    borderColor: "var(--color-border)",
                ...
                >
                  {XPATH_FIELDS.map((f) => (
                    <button
                      key={f.key}
                      className="w-full px-3.5 py-2 text-left text-xs transition-colors hover:opacity-80"
