...
import { generateXPathFromKeyword } from "../xpathTool";
...
export function useXPathGenerate(
  ...
  const handleAdjust = useCallback((field: TargetField) =>
    runGenerate(field, fields[field].anchorXPath), [runGenerate, fields]);
