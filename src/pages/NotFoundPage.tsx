  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative z-10 flex flex-col items-center gap-6 rounded-2xl px-10 py-12"
        style={{
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center">
          <motion.div
            ...
            className="text-8xl leading-none font-black tracking-tighter"
            style={{
              background:
                "linear-gradient(135deg, var(--color-accent), color-mix(in srgb, var(--color-accent) 50%, var(--color-text-muted)))",
